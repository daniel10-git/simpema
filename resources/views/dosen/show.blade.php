                            ...
                            <div class="w-full md:w-1/2">
                                <form class="flex items-center">
                                    ...
                                    <div class="relative w-full">
                                        ...
                                        <input type="text" id="simple-search" placeholder="Search" required="" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:placeholder-gray-400">
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            {{-- <form action="{{ route('dosen.editmhs', ['id' => $m->id]) }}" method="GET"> --}}
                                                <button type="button" id="updateProductButton" data-modal-target="updateProductModal{{ $m->id }}" data-modal-toggle="updateProductModal{{ $m->id }}" class="text-yellow-500 hover:text-yellow-700 mx-2">
                                            ...
                                            <!-- Delete Mahasiswa -->
                                            <form action="{{ route('dosen.destroy', ['id' => $m->id]) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" data-modal-target="delete-modal" data-modal-toggle="delete-modal" class="text-red-500 hover:text-red-700 mx-2">
