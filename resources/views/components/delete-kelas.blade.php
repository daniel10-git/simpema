<div>
    <!-- Delete Modal -->
    <div id="delete-kelas{{ $d->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Anda yakin ingin menghapus
                        data ini ?</h3>
                    <form action="{{ route('destroykelas', $d->id) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
                    ...
                    <a href="{{ route('layouts.kelas') }}" data-modal-toggle="delete-modal" type="button"
