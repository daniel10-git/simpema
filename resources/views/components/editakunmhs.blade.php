<div>
    <!-- Main modal edit-->
    <div id="updateAkunMahasiswa{{ $m->id_user }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto mx-auto mt-10">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="p-6 space-y-6">
                    <form action="{{ route('updateakunmahasiswa', ['id_user' => $m->id_user]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-4">
                            <label for="name"
                                class="block text-sm font-medium text-gray-900 dark:text-white">Username</label>
                            <input type="text" name="name" id="name" value="{{ $m->user->name }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name="email" id="email" value="{{ $m->user->email }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                required>
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="password" name="password" id="password"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kosongkan jika tidak ingin
